<?php 
 ...
 if(isset($_GET['edit'])){
   ...
   $query2 = $db->query("SELECT * FROM banner1 where id_banner1=".$id_box);
   $user = $query2->fetch();
}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="POST" action="<?php if(isset($_GET['edit'])){ echo "updatebanner1.php"; }else { echo "addbanner1.php"; } ?>" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php if(isset($_GET['edit'])){ echo($user['id_banner1']); }?>">
						...
						<div class="table-responsive">
							<table class="table table-stripped table-bordered">
								...
								<tbody>
										...
										<tr>
                                        <td><?=$ligne['id_banner1'];?></td>
                                            <td><img class="pro" src="images/<?=$ligne['photo'];?>"></td>
											<td><?php echo($ligne['titre']); ?></td>
											<td><?php echo($ligne['texte']) ?></td>
											<td><?php echo(($ligne['date_post'])) ?></td>
											<td><a class="btn btn-primary" href="banner1.php?edit=<?php  echo($ligne['id_banner1']) ?>" >Editer</a></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
