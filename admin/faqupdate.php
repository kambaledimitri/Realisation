 ...
 function imgup()
{
  ...
  if(move_uploaded_file($_FILES['photo']['tmp_name'],'imagesfaq/'.$url_img)){
     ...
     $req=$db->prepare('UPDATE  faqsection SET question1=:question1,reponse1=:reponse1,question2=:question2,
     reponse2=:reponse2,question3=:question3,reponse3=:reponse3,question4=:question4,
     reponse4=:reponse4,photo=:photo WHERE id=:id');
     $req->execute(array(
  ...
  return true;
      ...
      require 'config/connect.php';
    $req=$db->prepare('UPDATE  faqsection SET question1=:question1,reponse1=:reponse1,question2=:question2,
    reponse2=:reponse2,question3=:question3,reponse3=:reponse3,question4=:question4,reponse4=:reponse4 WHERE id=:id');
     $req->execute(array(
     'question1' => $question1,
     'reponse1' => $reponse1,
     'question2' => $question2,
