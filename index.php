<?php 
  ...
  //index jered//
   ...
   $about = $db->query('SELECT * FROM about1 ORDER BY id DESC limit 1');
   $image = $db->query('SELECT * FROM image ORDER BY id');
   $faq = $db->query('SELECT * FROM faqsection ORDER BY id DESC limit 1');
  //index dimitri//
                    ...
                    <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
                        ...
                        <div class="col-md-2 col-lg-6">
                            ...
                            <div class="about-content-right">
                             <img class="b" src="admin/pictures/<?=$b['photo'];?>" alt="app image" class="img-fluid">
            ...
            <div class="container police">
               ...
               <?php while ($b = $faq->fetch()) {?>
                    <div class="col-md-6 col-lg-6 mb-5 mb-md-5 mb-sm-5 mb-lg-0">
                        <div class="img-wrap">
                            <img class="bb" src="admin/imagesfaq/<?=$b['photo'];?>" alt="download" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div id="accordion" class="accordion faq-wrap">
                            ...
                            <div class="card mb-3">
                                <a class="card-header " data-toggle="collapse" href="#collapse0" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block"><?=$b['question1'];?></h6>
                                </a>
                            ...
                            <div class="card my-3">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapse1" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block"><?=$b['question2'];?></h6>
                                </a>
                            ...
                            <div class="card my-3">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapse2" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block"><?=$b['question3'];?></h6>
                                </a>
                            ...
                            <div class="card mt-3">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapse3" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block"><?=$b['question4'];?></h6>
                                </a>
